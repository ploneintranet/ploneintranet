# -*- coding: utf-8 -*-
#
# Plone Intranet documentation build configuration file, created by
...
# Controlling whether words that look like package names from PyPI are
# treated as spelled properly
...
# of the sidebar.
html_logo = "_static/img/quaive-logo_horizontal-subline-4c.svg"
...
htmlhelp_basename = 'PloneIntranetDocumentation'
...
latex_documents = [
    ('index', 'PloneIntranet.tex', u'Plone Intranet Documentation',
     u'Plone Intranet Consortium', 'manual'),
]
...
man_pages = [
    ('index', 'ploneintranet', u'Plone Intranet Documentation',
     [u'Plone Intranet Consortium'], 1)
]
...
texinfo_documents = [
    ('index', 'PloneIntranet', u'Plone Intranet Documentation',
     u'Plone Intranet Consortium', 'PloneIntranet', 'One line description of project.',
     'Miscellaneous'),
]
