...
* typo [Alexander Pilz]
* Merge pull request #350 from quaive/update_proto [GitHub]
* Merge pull request #349 from quaive/filter-types-in-user-profile [GitHub]
* Merge pull request #351 from quaive/347_microblog_ondelete [GitHub]
...
* Update to latest proto [ale-rt]
* Omit from the search the document types we are not interested into [ale-rt]
* Keep an archive of deleted statusupdates [Guido A.J. Stevens]
* Merge pull request #346 from quaive/fix-microblog-upgrade-to-0009 [GitHub]
* Merge pull request #338 from quaive/326-search-user-contents-in-profile-group-by-date [GitHub]
* Merge pull request #345 from quaive/dashboard-selection-persist-on-the-user [GitHub]
* Fix microblog upgrade to 0009 [ale-rt]
* Persist the dashboard selection on the user [ale-rt]
* Merge pull request #336 from quaive/109_tag_streams [GitHub]
* Implement grouping by date [ale-rt]
* Merge pull request #343 from quaive/335_take2 [GitHub]
* Revert "Merge pull request #341 from quaive/dashboard-selection-recordable" [Guido A.J. Stevens]
* Merge pull request #339 from quaive/326-user-contents-in-profile-fix-unicode [GitHub]
* Merge pull request #341 from quaive/dashboard-selection-recordable [GitHub]
...
* Add history: record for dashboard selection [ale-rt]
* Fix an issue when the first letter is a unicode string [ale-rt]
* search in the context of the user [ale-rt]
* Merge pull request #331 from quaive/326-user-contents-in-profile [GitHub]
...
* Merge pull request #333 from quaive/missing-pat-date-picker-i18n [GitHub]
* Merge pull request #334 from quaive/notify-on-role-change [GitHub]
* If guest roles are granted or removed, throw the WorkspaceRosterChangedEvent [Wolfgang Thomas]
* Add missing pat-date-dicker i18n [ale-rt]
* Remove sorting for the time being [ale-rt]
...
* Persist workspace sorting options [ale-rt]
...
* Rebased on master [ale-rt]
* translate heading "Guests" [ale-rt]
...
* Do not limit search results we are looking for the section children [ale-rt]
...
* Fixes suggested by zptlint [ale-rt]
...
* Do not execute as manager [ale-rt]
...
* Allow easy override for management port [ale-rt]
* Warn when we cannot change the locale [ale-rt]
...
* Update review state tests [ale-rt]
* Case freeze: use less guarded exit transitions, add robot tests [ale-rt]
* Case freeze: add "frozen" to the case manager filter [ale-rt]
* Resolve conflicts in sidebar [ale-rt]
...
* Rebase branch to master [ale-rt]
...
* Make is_archived and date_archived work equally [ale-rt]
...
* Revert "Refactor tests and documentation to use supported views for managing templates" [ale-rt]
...
* updated js bundle [ale-rt]
* update to fix locale support [ale-rt]
* update to fix locale support [ale-rt]
...
* Implement collation in search view facets [ale-rt]
...
* Fix typo in division grouping template [ale-rt]
* fix test regression [Guido A.J. Stevens]
...
* Fix the date time attribute [ale-rt]
...
* Use pat-display-time instead of pat-moment [ale-rt]
...
* Fix a js error in robot tests [ale-rt]
* Add the description field in the event view [ale-rt]
* Improve ploneintranet.api.userprofile.get [ale-rt]
* Merge pull request #209 from quaive/unifiy-user-getters [Wolfgang Thomas]
* use get_state to get the review_state [ale-rt]
* Change default entry in selects [ale-rt]
...
* Persistent search options [ale-rt]
...
* The insufficient privileges has a status message [ale-rt]
...
* Decrease complexity in longkeysortreverse [ale-rt]
...
* Remove unzip=true from buildout [ale-rt]
* Understand ajax_load parameter [ale-rt]
* Append the webstats_js view [ale-rt]
* Refactor for readability [ale-rt]
* take new async into account and reindex immediately [ale-rt]
* don't reindex async anymore, actually only do it for SearchableTest [ale-rt]
* Remove old dependency [Alexander Pilz]
* Fix code analisys [ale-rt]
* Latest generated styles after todays make diazo [ale-rt]
* Do not notify ObjectModifiedEvent just to trigger a catalog reindex [ale-rt]
...
* Update option label [ale-rt]
* Also update workflow-menu [ale-rt]
* Avoid to reindex twice [ale-rt]
* We do not want an event on workflow transitions [ale-rt]
* Fix event notification [ale-rt]
...
* Backend allows templates for all workspace types [ale-rt]
...
* Do nothing on copy [ale-rt]
* Listen also for ObjectCreatedEvent [ale-rt]
* Fire ObjectCreatedEvent at creation [ale-rt]
...
* Return the production bundle if we ploneintranet bundle is disabled (happens in the library) [ale-rt]
* Do not pull in resources from the production bundle [ale-rt]
* Disable production bundle [ale-rt]
* Disable injection hooks in the modal [ale-rt]
...
* The view @@apps.html is now configurable [ale-rt]
* Added generated/style after make diazo [ale-rt]
...
* Nuke transitions while robot testing [ale-rt]
...
* Add history button in the metromap [ale-rt]
...
* Make robot keywords properly wait for injection to finish [ale-rt]
* Merge pull request #143 from quaive/132-update-theme-step-1 [Guido Stevens]
* Change task sorting criterion [ale-rt]
* New audit view template from prototype and rules.xml [ale-rt]
...
* scorched is always required [ale-rt]
...
* Conditionally add the history button to the one available [ale-rt]
* rules to include audit log [ale-rt]
* Ignore some packages a developer can find in its src folder [ale-rt]
...
* use pi_api to retrieve users and also sort the results [ale-rt]
* Metromap: fix display of transition icons and titles [ale-rt]
* fix icons [ale-rt]
...
* Use more meaningfull title and descriptions [ale-rt]
* Document portal registry [ale-rt]
...
* Clean up references to old code/logic [ale-rt]
* Fix import step dependency [ale-rt]
...
* This improvess the robustness of the tests [ale-rt]
...
* added i18n statements for texts in batch delete form. [ale-rt]
* also make selection classes available on event add form [ale-rt]
* autocolour groups [ale-rt]
...
* Fix UUIDindex when no division is set [ale-rt]
...
* fix todo title. Can't fix that in PI first as we are building up unmerged pull requests [ale-rt]
...
* trigger ObjectModifiedEvent when task is closed or re-opened. Remove extra reindexObject call [ale-rt]
* Case reject: handle milestone states not in the MM [ale-rt]
* Refs #12692 Case: treat a WF state not in the MMap as a future state [ale-rt]
* ThemeSwitcher: Also allow hostname_default to be configured from buildout [ale-rt]
* Tiles in the dashboard are configurable [ale-rt]
* Other configurations for workspaces [ale-rt]
...
* Workspace sorting [ale-rt]
* Merge pull request #74 from quaive/case-manager-review-states [Wolfgang Thomas]
* Configure the states in the dropdown menu of the case manager view [ale-rt]
...
* Fix divisions vocabulary [ale-rt]
* First introduction of the case case-manager view [ale-rt]
* Fix test runner [ale-rt]
* More advanced testing [ale-rt]
* Make tests more high load resistant [ale-rt]
* Add the date-picker-i18n.json view [ale-rt]
* Merge pull request #68 from quaive/more-flexibility-while-creating-cases-in-testing-profile [Alexander Pilz]
* create_caseworkspaces function has more parameters [ale-rt]
...
* Division fields in the workspace sidebar [ale-rt]
