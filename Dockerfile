...
run apt-get update
run apt-get update && apt-get install -y python-dev gcc make zlib1g-dev libjpeg-dev python-virtualenv git-core libfreetype6-dev gettext python-pip libxslt1-dev python-lxml jed firefox xvfb npm nodejs ruby ruby-dev libenchant-dev python-gdbm python-tk graphicsmagick poppler-utils poppler-data ghostscript pdftk libreoffice chromium-browser chromium-chromedriver redis-server libffi-dev
